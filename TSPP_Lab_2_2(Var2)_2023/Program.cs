//TSPP_Lab_2_2(Var2)_2023 Виведення значень функції з заданого діапазону з кроком (Цикли з післяумовою).
using System;
namespace TSPP_Lab_2_2_Var2_2023
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (((b - a) / dx) < 2);
            Console.Clear();
            //Обчислення та виведення в консоль
